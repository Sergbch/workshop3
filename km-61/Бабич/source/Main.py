...
@app.route('/createDocByTemplate', methods=['GET'])
...
def dashboard():
    ...
    query1  = (
                ...
                ormUser.full_name,
                func.count(ormcreateDocByTemplate.patch_file).label('document_count')).\
                outerjoin(ormcreateDocByTemplate).\
    ...
    query2 = (
        db.sqlalchemy_session.query(
            ...
            func.count(ormcreateDocByTemplate.email).label('user_count')). \
            outerjoin(ormcreateDocByTemplate). \
